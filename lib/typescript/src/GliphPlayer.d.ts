...
declare const GliphPlayer: {
     ...
     */
    skip(index: number, initialPosition?: number, autoPlay?: boolean): Promise<void>;
     ...
     * @param autoPlay - Whether to automatically start playback (default: true)
     */
    skipToNext(initialPosition?: number, autoPlay?: boolean): Promise<void>;
     ...
     * @param autoPlay - Whether to automatically start playback (default: true)
     */
    skipToPrevious(initialPosition?: number, autoPlay?: boolean): Promise<void>;
