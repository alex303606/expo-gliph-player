...
exports.isBuffering = isBuffering;
exports.isPaused = isPaused;
exports.isPlaying = isPlaying;
exports.isStopped = isStopped;
var _reactNative = require("react-native");
var _NativeGliphPlayer = _interopRequireDefault(require("./specs/NativeGliphPlayer"));
...
let _emitter = null;
function getEmitter() {
  if (!_NativeGliphPlayer.default) {
    throw new Error('[RNGliphPlayer] Native module not found. Is it linked correctly?');
  }
  if (!_emitter) {
    _emitter = new _reactNative.NativeEventEmitter(_NativeGliphPlayer.default);
  }
  return _emitter;
}
...
function checkModule() {
  ...
  return _NativeGliphPlayer.default;
}
...
const GliphPlayer = {
  ...
  async setupPlayer(options = {}) {
    ...
    return _NativeGliphPlayer.default.setupPlayer(opts);
  },
  /**
...
var _default = exports.default = GliphPlayer; // ─── Convenience state helpers ────────────────────────────────────────────────
function isPlaying(state) {
  return state === _types.State.Playing;
}
function isPaused(state) {
  return state === _types.State.Paused;
}
function isBuffering(state) {
  return state === _types.State.Buffering || state === _types.State.Loading;
}
function isStopped(state) {
  return state === _types.State.Stopped || state === _types.State.None;
}
