...
const GliphPlayer = {
     ...
     * @param initialPosition - Position in seconds to start from (default: -1 = start)
     * @param autoPlay - Whether to automatically start playback (default: true)
     */
    async skip(index: number, initialPosition?: number, autoPlay: boolean = true): Promise<void> {
        return checkModule().skip(index, initialPosition ?? -1, autoPlay);
    },
     ...
     * @param autoPlay - Whether to automatically start playback (default: true)
     */
    async skipToNext(initialPosition?: number, autoPlay: boolean = true): Promise<void> {
        return checkModule().skipToNext(initialPosition ?? -1, autoPlay);
    },
     ...
     * @param autoPlay - Whether to automatically start playback (default: true)
     */
    async skipToPrevious(initialPosition?: number, autoPlay: boolean = true): Promise<void> {
        return checkModule().skipToPrevious(initialPosition ?? -1, autoPlay);
    },
